...
set_property PACKAGE_PIN N17 [get_ports {homerun}]
   set_property IOSTANDARD LVCMOS33 [get_ports {homerun}]
## Sch name = JC4
...
## Pmod Header JXADC
# ## Sch name = XA1_P
# set_property PACKAGE_PIN J3 [get_ports {player1}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {player1}]
# ## Sch name = XA2_P
# set_property PACKAGE_PIN L3 [get_ports {playe2}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {player2}]
# ## Sch name = XA3_P
# set_property PACKAGE_PIN M2 [get_ports {homerun}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {homerun}]
# ## Sch name = XA4_P
